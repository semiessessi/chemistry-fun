...
// ---- sampleDensityGridGPU (stub — moList path uses workers for now) ----

export async function sampleDensityGridGPU(moList, N, halfExtent) {
  // Density requires summing multiple MO contributions; complex to batch on GPU.
  // Worker-WASM path handles this case adequately. Return null to fall through.
  return null;
}
